 ...
 * Java控制台词汇库
 */
public class Practise_Java_C extends JFrame {
    /**
     * correct 获取总个数
     * remaining 获取正确个数
     * txtS1
    ...
    public Practise_Java_C() {
        ...
        txtS2.setColumns(10);
        txtS2.setText(Global_data.jv.get(Global_data.jc.get(z)));
        //显示从集合中调用的内容内容
        ...
        btnNewButton_1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ...
                    //执行插入数据
                    JOptionPane.showMessageDialog(null, "单词“" + Global_data.jv.get(Global_data.jc.get(z)) + "”收录成功!");
                } catch (Exception ex) {
        ...
        btnNewButton_2.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                txtS3.setText(Global_data.jv.get(Global_data.jc.get(z)));
                //题目
                txtS4.setText(Global_data.jc.get(z));
                //答案
                correct--;
                //每次递减
                if (Global_data.jc.get(z).equals(txtS1.getText())) {
                    remaining++;
                }//判断是否正确
                else {
                    if (Global_data.cka) {
