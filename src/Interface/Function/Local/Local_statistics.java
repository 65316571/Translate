...
public class Local_statistics extends JFrame{
    ...
    public Local_statistics() {
        ...
        JLabel lblNewLabel_1 = new JLabel("中文  正确:" + Global_data.sumCy+" 错误:" + Global_data.sumCn+" 总共:"+(Global_data.sumCy+ Global_data.sumCn)+" 正确率:"+sumC+"%");
        lblNewLabel_1.setFont(new Font("宋体", Font.PLAIN, 25));
        lblNewLabel_1.setBounds(15, 170, 500, 50);
        contentPane.add(lblNewLabel_1);
        //文本框_1
        JLabel lblNewLabel_2 =  new JLabel("英文  正确:" + Global_data.sumEy+" 错误:" + Global_data.sumEn+" 总共:"+(Global_data.sumEy+ Global_data.sumEn)+" 正确率:"+sumE+"%");
        lblNewLabel_2.setFont(new Font("宋体", Font.PLAIN, 25));
        lblNewLabel_2.setBounds(15, 220, 500, 50);
        contentPane.add(lblNewLabel_2);
        //文本框_2
        JLabel lblNewLabel_3 =  new JLabel("综合 正确:" +(Global_data.sumEy+ Global_data.sumCy)+" 错误:" +(Global_data.sumEn+ Global_data.sumCn)+" 数量:" +(Global_data.sumEn+ Global_data.sumCn+ Global_data.sumEy+ Global_data.sumCy)+" 正确率:" +sum+"%");
        lblNewLabel_3.setFont(new Font("宋体", Font.PLAIN, 25));
        lblNewLabel_3.setBounds(15, 270, 500, 50);
